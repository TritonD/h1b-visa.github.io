...
### 2018 US H-1B Application Numbers by States (Worksite vs. Employer's Headquarter)
...
## Removed locations that are not states
## Collapse worksite states and employer states that are too sparse
h1b_location =
  h1b_18_filter %>% 
...
##Gradient colors were used to show density of H-1B applicants.
g2 <- list(
  scope = 'usa',
...
## Use plot_geo (instead of plotly) to create map of the US with observations as scatterpoints
...
### 2018 US Average Wage of H-1B Applicants by Worksite
